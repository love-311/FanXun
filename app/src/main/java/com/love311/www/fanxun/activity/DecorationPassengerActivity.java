 ...
 */
public class DecorationPassengerActivity extends AutoLayoutActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.decoration_passenger_activity);
        ...
        topLeft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DecorationPassengerActivity.this.setResult(RESULT_OK, intent);
                DecorationPassengerActivity.this.finish();
            }
        });
        topMid.setText("装修");
        ...
        if (statusString.equals("清水")) {
            ...
            ivNo.setBackgroundResource(R.mipmap.choosed);
        }
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.rl_no:
                intent = new Intent();
                intent.putExtra("decoration", "无要求");
                intent.putExtra("decoration_status", decoration_status);
                DecorationPassengerActivity.this.setResult(RESULT_OK, intent);
                DecorationPassengerActivity.this.finish();
                break;
