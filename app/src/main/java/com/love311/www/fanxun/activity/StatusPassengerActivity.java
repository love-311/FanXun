 ...
 */
public class StatusPassengerActivity extends AutoLayoutActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.status_passenger_activity);
        ...
        topLeft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                StatusPassengerActivity.this.setResult(RESULT_OK, intent);
                StatusPassengerActivity.this.finish();
            }
        });
        topMid.setText("客户状态");
